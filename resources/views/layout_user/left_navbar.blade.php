            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        <li class="nav-item ">
                            <a class="js-nav-tooltip-link nav-link " href="" title="Welcome page" data-placement="left">
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle active" href="javascript:;" title="Kelola SSPD">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li class="nav-item">
                                <a class="nav-link active" href="{{ route('sspd.create') }}" title="Input SSPD">
                        ...
                        <!-- <li class="nav-item ">
                            <a class="js-nav-tooltip-link nav-link {{ request()->is('sspd/create') ? 'active' : '' }}" href="{{ route('sspd.create') }}" title="Welcome page" data-placement="left">
                                <i class="tio-files-outlined nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Input SSPD </span>
                            </a>
                        </li> -->
                        <li class="nav-item ">
