    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            ...
            <form class="js-step-form js-validate py-md-5" data-hs-step-form-options='{
                ...
                "isValidate": true
              }' method="post" action="{{ route('sspd.update', $data->kd_booking) }}" enctype="multipart/form-data" id="formTransaksiEdit">
              @csrf
              @method('PUT')
                        ...
                        <div id="addUserStepFormContent">                            
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            }' name="nop" id="nop" value="{{ $data->nop }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="js-form-message">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="js-masked-input form-control" name="hargatransaksi" id="hargatransaksi" value="{{ $data->harga_transaksi }}"
                                                    data-hs-mask-options='{
                                                        "template": "#.##0",
                                                        "selectOnFocus": true,
                                                        "reverse": true
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="js-masked-input form-control" name="npop" id="npop" value="{{ $data->npop}}"
                                                    data-hs-mask-options='{
                                                        "template": "#.##0",
                                                        "selectOnFocus": true,
                                                        "reverse": true
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="js-masked-input form-control col-sm-4" name="npoptkp" id="npoptkp" placeholder="NPOPTKP" aria-label="npoptkp" value="{{ $data->npoptkp }}"
                                                    data-hs-mask-options='{
                                                        "template": "#.##0",
                                                        "selectOnFocus": true,
                                                        "reverse": true
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="js-masked-input form-control"  name="npopkp" id="npopkp" value="{{ $data->npopkp }}"
                                                data-hs-mask-options='{
                                                    "template": "#.##0",
                                                    "selectOnFocus": true,
                                                    "reverse": true
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="js-masked-input form-control" name="bphtb" id="bphtb" value="{{ $data->bphtb_terutang }}"
                                                data-hs-mask-options='{
                                                    "template": "#.##0",
                                                    "selectOnFocus": true,
                                                    "reverse": true
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="js-masked-input form-control" name="bphtb_dibayar" id="bphtb_dibayar" value="{{ $data->bphtb_yg_harus_dibayar }}"
                                                data-hs-mask-options='{
                                                    "template": "#.##0",
                                                    "selectOnFocus": true,
                                                    "reverse": true
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jns_setoran" id="customRadio1" value="1" @if($data->jns_setoran === '1') checked @endif>
                                                <label class="form-check-label" for="customRadio1">
                                                    Penghitungan Wajib Pajak
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jns_setoran" id="customRadio2" value="2" @if($data->jns_setoran === '2') checked @endif>
                            ...
                            <div id="addUserStepConfirmation" class="card card-lg" style="display: none;">
                                ...
                                <div class="card-footer d-sm-flex align-items-sm-center">
                                    ...
                                    <div class="ml-auto">
                                        <input type="hidden" value="{{ $data->kd_bphtb }}" name="kd_bphtb">
                                        <button type="submit" class="btn btn-primary" id="btnTransaksiEdit">Update Data </button>
                                    </div>
                                </div>
                                <!-- End Footer -->
                            </div>
