        ...
        <div class="page-header">
          <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
              <h1 class="page-header-title">Verifikasi Transaksi BPHTB </h1>
            </div>
            ...
            <table id="datatable" class="table table-lg table-bordered table-thead-bordered table-hover table-align-middle card-table"
              ...
              <thead class="thead-light">
                <tr>
                  ...
                  <th rowspan="2" style="vertical-align: middle;" class="text-center pb-1">Kode Tanggal Billing</th>
                  <th rowspan="2" style="vertical-align: middle;" class="text-center pb-1">Luas Tanah / Bangunan</th>
                  <th rowspan="2" style="vertical-align: middle;" class="text-center pb-1">Keterangan</th>
                  <th rowspan="2" style="vertical-align: middle;" class="text-center pb-1">SSPD</th>
                  <th rowspan="2" style="vertical-align: middle;" class="text-center pb-1">BPHTB Belum Dibayar</th>
                  <th rowspan="2" style="vertical-align: middle;" class="text-center pb-1">Berkas</th>
                  <th colspan="3" class="text-center pt-1 pb-1">Status Validasi</th>
                  <th rowspan="2" style="vertical-align: middle;" class="text-center pb-1">Catatan Validator</th>
                  <th rowspan="2" style="vertical-align: middle;" class="text-center pb-1">Aksi</th>
                </tr>
                <tr>
                  <th class="text-center pb-1 pt-1">AR</th>
                  <th class="text-center pb-1 pt-1">Kasi</th>
                  <th class="text-center pb-1 pt-1">Kabid</th>
                </tr>
              </thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-center">...</td> <!-- NOP -->
                  <td class="text-center">...</td> <!-- Nama Pembeli -->
                  <td class="text-center">...</td> <!-- Kode Tanggal Billing -->
                  <td class="text-center">...</td> <!-- Luas Tanah / Bangunan -->
                  <td class="text-center">...</td> <!-- Keterangan -->
                  <td class="text-center">...</td> <!-- SSPD -->
                  <td class="text-center">...</td> <!-- BPHTB -->
                  <td class="text-center">...</td> <!-- Berkas -->
                  <td class="text-center">✔</td> <!-- Validasi AR -->
                  <td class="text-center">✔</td> <!-- Validasi Kasi -->
                  <td class="text-center">✔</td> <!-- Validasi Kabid -->
                  <td class="text-center">Catatan disini</td> <!-- Catatan Validator -->
                  <td class="text-center">
                    <select class="custom-select custom-select-sm aksiData">
                      <option selected="0">Aksi</option>
                      <option value="1">Lihat SSPD</option>
                      <option value="2">Cetak Lampiran</option>
                    </select>
                  </td>
                </tr>
              </tbody>
